...
public class WorkerDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        thread2.join();
        timePrintWorker.stopWorker(); // höfliches STOPPEN ! -> setzt shouldRun auf FALSE
        // thread1.interrupt(); // unhöfliches STOPPEN ! -> Methode könnte nicht zur Gänze ausgeführt werden!
        thread1.join();
